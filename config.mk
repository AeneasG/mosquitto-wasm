...
ifeq ($(WITH_TLS),yes)
	...
	ifeq ($(WITH_WOLFSSL),yes)
		BROKER_LDADD:=$(BROKER_LDADD) -lwolfssl -DWITH_WOLFSSL -DOPENSSL_NO_ENGINE
		CLIENT_CPPFLAGS:=$(CLIENT_CPPFLAGS) -DWITH_TLS -DWITH_WOLFSSL
		LIB_LIBADD:=$(LIB_LIBADD) -lwolfssl -DWITH_WOLFSSL -DOPENSSL_NO_ENGINE
		PASSWD_LDADD:=$(PASSWD_LDADD) -lwolfssl -DWITH_WOLFSSL
		STATIC_LIB_DEPS:=$(STATIC_LIB_DEPS) -lwolfssl -DWITH_WOLFSSL -DOPENSSL_NO_ENGINE
		APP_CPPFLAGS:=$(APP_CPPFLAGS) -DWITH_WOLFSSL
		BROKER_CPPFLAGS:=$(BROKER_CPPFLAGS) -DWITH_WOLFSSL -DOPENSSL_NO_ENGINE
		CLIENT_CPPFLAGS:=$(CLIENT_CPPFLAGS) -DWITH_WOLFSSL
		LIB_CPPFLAGS:=$(LIB_CPPFLAGS) -DWITH_WOLFSSL -DOPENSSL_NO_ENGINE
